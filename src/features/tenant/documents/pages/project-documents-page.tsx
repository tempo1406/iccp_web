...
import {
  useProjectDocumentsPage,
  encodeDragPayload,
} from '../hooks/use-project-documents-page';
...
export function ProjectDocumentsPage({ projectId }: ProjectDocumentsPageProps) {
  const {
    selectedFolderId,
    setSelectedFolderId,
    recoverySelected,
    ...
    handleLibraryDrop,
  } = useProjectDocumentsPage(projectId);
                ...
                <div className="flex items-center gap-1.5">
                  {isMobile ? (
                    <Button
                      size="sm"
                      variant="outline"
                      className="border-border bg-background h-7 w-7 p-0"
